...
function cipher_and_encoded_image_row_temp = operate3_inverse_edition(encoded_key_image_row, encoded_plain_image_row)
...
for i = 1:length_
    ...
    cipher_and_encoded_image_row_temp(i) = opt3_inverse_edition(a, b);
end;